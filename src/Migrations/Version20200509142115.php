 ...
 */
final class Version20200509142115 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE education_degree (id INT AUTO_INCREMENT NOT NULL, label VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE \'utf8mb4_unicode_ci\' ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, first_name VARCHAR(128) NOT NULL, last_name VARCHAR(128) NOT NULL, birth_date DATE NOT NULL, email VARCHAR(255) NOT NULL, phone INT DEFAULT NULL, address VARCHAR(255) DEFAULT NULL, city VARCHAR(128) DEFAULT NULL, country INT DEFAULT NULL, username VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE \'utf8mb4_unicode_ci\' ENGINE = InnoDB');
		...
		$this->addSql('INSERT INTO education_degree(label) VALUES (\'Bachelor\'), (\'Master\'), (\'Ingeneering\'), (\'Phd\')');
    }
